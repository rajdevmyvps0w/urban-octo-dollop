# Contributing to Runa (ルナ) – 月の光

Thank you for considering contributing to Runa (ルナ) – 月の光. This document provides guidelines and instructions for contributing to the project.
...
Report violations to: Runa (ルナ) – 月の光.bot.official@gmail.com
...
2. **Clone your fork**:
    ...
    ```bash
    git clone https://github.com/YOUR-USERNAME/Runa (ルナ) – 月の光.git
    cd Runa (ルナ) – 月の光
    ```
...
3. **Add upstream remote**:
    ...
    ```bash
    git remote add upstream https://github.com/naruyaizumi/Runa (ルナ) – 月の光.git
    ```
...
- Runa (ルナ) – 月の光 version: [e.g., 10.0.0]
...
- **Email**: Runa (ルナ) – 月の光.bot.official@gmail.com

---

## License

By contributing to Runa (ルナ) – 月の光, you agree that your contributions will be licensed under the Apache License 2.0.

You retain copyright to your contributions but grant Runa (ルナ) – 月の光 and users the rights specified in the Apache License 2.0.

---

**Thank you for contributing to Runa (ルナ) – 月の光!**

Made with dedication by the Runa (ルナ) – 月の光 community.
