...
<img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=6,11,20&height=200&section=header&text=Runa (ルナ) – 月の光%20Bot&fontSize=80&fontAlignY=35&animation=twinkling&fontColor=fff&desc=Enterprise-Grade%20WhatsApp%20Bot%20Framework&descAlignY=55&descSize=18" width="100%" />

![Runa (ルナ) – 月の光 Banner](https://files.catbox.moe/3xv7p0.png)
...
Runa (ルナ) – 月の光 is an enterprise-ready WhatsApp bot framework designed for developers who demand **performance**, **reliability**, and **scalability**. Built with modern technologies and battle-tested architecture patterns.
...
```bash
curl -fsSL https://raw.githubusercontent.com/naruyaizumi/Runa (ルナ) – 月の光/main/install.sh | bash
```
...
Runa (ルナ) – 月の光 supports multiple prefixes:
...
Service file auto-created by installer at `/etc/systemd/system/Runa (ルナ) – 月の光.service`

```bash
sudo systemctl start Runa (ルナ) – 月の光
sudo systemctl enable Runa (ルナ) – 月の光
sudo systemctl status Runa (ルナ) – 月の光
```
...
**Report vulnerabilities to:** Runa (ルナ) – 月の光.bot.official@gmail.com
...
- 💚 All [contributors](https://github.com/naruyaizumi/Runa (ルナ) – 月の光/graphs/contributors) who made this possible
...
<div align="center">
  ...
  <a href="https://star-history.com/#naruyaizumi/Runa (ルナ) – 月の光&Date">
    <img src="https://api.star-history.com/svg?repos=naruyaizumi/Runa (ルナ) – 月の光&type=Date" width="700" alt="Star History Chart"/>
  </a>

  <hr/>

  <p><strong>Maintained by the Runa (ルナ) – 月の光 community || <a href="https://github.com/naruyaizumi">© 2024 - 2026 Sten-X</a></strong></p>
