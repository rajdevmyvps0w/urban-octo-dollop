 ...
 * for Runa (ルナ) – 月の光 bot with environment-based configuration.
 * @license Apache-2.0
 * @author Sten-X
 */
...
const initializeConfig = () => {
    ...
    const config = {
        ...
        watermark: Bun.env.WATERMARK || "Runa (ルナ) – 月の光",
        author: Bun.env.AUTHOR || "Sten-X",
        stickpack: Bun.env.STICKPACK || "Runa (ルナ) – 月の光",
        stickauth: Bun.env.STICKAUTH || "© Sten-X",
